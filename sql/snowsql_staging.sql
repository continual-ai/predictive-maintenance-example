...
SELECT * FROM PREDICTIVE_MAINTENANCE.AZURE_VM.ERRORS LIMIT 10;
SELECT * FROM PREDICTIVE_MAINTENANCE.AZURE_VM.FAILURES LIMIT 10;
SELECT * FROM PREDICTIVE_MAINTENANCE.AZURE_VM.MACHINES LIMIT 10;
SELECT * FROM PREDICTIVE_MAINTENANCE.AZURE_VM.MAINTENANCE LIMIT 10;
SELECT * FROM PREDICTIVE_MAINTENANCE.AZURE_VM.TELEMETRY LIMIT 10;
